...
- 💛 **Yellow** — parts moved (rendered at their NEW v2 position in high-contrast yellow) — paired with a hot pink ghost rendered at the OLD v1 position so you can trace the movement
...
| 💛 Yellow + hot pink ghost | moved | A part exists in both, but its world-space center moved > 0.01 mm or rotated > 0.01°. Yellow at the new v2 position, hot pink at the old v1 position. |
